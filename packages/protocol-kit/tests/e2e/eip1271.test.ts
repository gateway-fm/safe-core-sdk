import { hashTypedData } from '@gateway-fm/protocol-kit/utils/eip-712/encode'
import Safe, {
  hashSafeMessage,
  buildSignatureBytes,
...
import SafeMessage from '@gateway-fm/protocol-kit/utils/messages/SafeMessage'
...
import { asHash } from '@gateway-fm/protocol-kit/utils/types'
